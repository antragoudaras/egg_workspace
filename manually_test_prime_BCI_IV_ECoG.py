...
print('Final list with r2 average scores from each subject: {}'.format(accuracy_individual_list))
print('Average r2-valid score: {} across {} subjects'.format(np.array(accuracy_individual_list).mean(), i+1))