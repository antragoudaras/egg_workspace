...
parser.add_argument("--save-dataset", type=str, default='./dataset_extend_low_freq.xlsx', help="The path where the generated dataset will be stored")
...
d = {'n_filters_time': [40], 'filter_time_length': [25], 'n_filters_spat': [40], 'pool_time_length': [75], 'pool_time_stride': [15], 'drop_prob': [0.5], 'learning_rate_range': [0.0625], 'decay_range': [0], 'accuracy': [73.72]}
