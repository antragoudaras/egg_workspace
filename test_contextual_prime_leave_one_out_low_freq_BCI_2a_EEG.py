...
parser.add_argument("--interested-patient", type=int, default=2, help="Patient that was left out during zero-shot/contextual training for PRIME ")
...
df.to_excel(f"{prefix}_low_freq_ground_truth_results_contextual_BCI_2a_EEG_leave_one_out.xlsx")