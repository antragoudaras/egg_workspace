...
for j in range(10):
    ...
    print('Iteration_{j}: Average r2 valid list for subject_{i} : {}'.format(j,i,accuracy_individual_list))
    print('Iteration_{j}: Average r2 valid score: {i}'.format(j,i,np.array(accuracy_individual_list).mean()))
